...
const validateAssessment = (req, res, next) => {
    ...
    if (!assessment_type || !['quick_screening', 'anxiety_gad7', 'depression_phq9', 'sleep_quality', 'life_satisfaction', 'stress_level', 'comprehensive'].includes(assessment_type)) {
    ...
    if (!result_category || !['excellent', 'good', 'moderate', 'concerning', 'critical'].includes(result_category)) {
