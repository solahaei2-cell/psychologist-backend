...
const saveAssessment = async (req, res) => {
    try {
        ...
        const [result] = await executeQuery(
            ...
            [req.user.userId, assessment_type, JSON.stringify(questions), JSON.stringify(answers), total_score, max_possible_score, result_category, severity_level, JSON.stringify(recommendations)]
        );
